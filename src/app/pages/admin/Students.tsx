...
const studentsData = [
  { id: 1, name: 'John Doe', rollNo: 'CS2021001', department: 'Computer Science', year: '3rd', email: 'john@example.com', phone: '+1234567890', attendance: 94 },
  { id: 2, name: 'Jane Smith', rollNo: 'CS2021002', department: 'Computer Science', year: '3rd', email: 'jane@example.com', phone: '+1234567891', attendance: 91 },
  { id: 3, name: 'Bob Johnson', rollNo: 'ECE2021001', department: 'Electronics', year: '2nd', email: 'bob@example.com', phone: '+1234567892', attendance: 88 },
  { id: 4, name: 'Alice Brown', rollNo: 'ME2021001', department: 'Mechanical', year: '4th', email: 'alice@example.com', phone: '+1234567893', attendance: 96 },
  { id: 5, name: 'Charlie Wilson', rollNo: 'CS2022001', department: 'Computer Science', year: '2nd', email: 'charlie@example.com', phone: '+1234567894', attendance: 89 },
];
                  ...
                  <tr key={student.id} className="border-b border-border hover:bg-muted/50 transition-colors">
                    ...
                    <td className="py-3 px-4">
                      <span className={`px-2 py-1 rounded text-sm font-medium ${
                        student.attendance >= 90 ? 'bg-accent/10 text-accent' :
                        student.attendance >= 75 ? 'bg-orange-100 text-orange-600 dark:bg-orange-900/20' :
