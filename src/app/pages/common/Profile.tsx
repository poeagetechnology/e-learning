        ...
        <Card className="lg:col-span-1">
          <CardContent className="pt-6">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">Computer Science • 3rd Year</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input type="email" defaultValue="john.doe@college.edu" className="pl-10" />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input type="tel" defaultValue="+1 234 567 8900" className="pl-10" />
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input type="date" defaultValue="2002-05-15" className="pl-10" />
                  </div>
                </div>
                <div>
        ...
        <Card>
          ...
          <CardContent>
            <form className="space-y-4">
              ...
              <Button variant="outline" className="w-full">Update Emergency Contact</Button>
            </form>
          </CardContent>
        </Card>
      </div>
