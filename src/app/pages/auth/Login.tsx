      ...
      <div className="hidden lg:flex flex-col justify-between w-[45%] relative p-12 overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          <AnimatePresence mode="wait">
            ...
            >
              <div className="w-20 h-20 rounded-3xl bg-white/20 backdrop-blur-sm flex items-center justify-center mb-6 shadow-2xl ring-1 ring-white/30">
        ...
        <div className="relative z-10">
          <p className="text-white/40 text-xs">
            &copy; 2026 CollegeMS – Built for modern institutions
          </p>
        </div>
      </div>
            ...
            <div className="grid grid-cols-5 gap-2">
              {roles.map((role) => (
                <button
                  ...
                  className={`py-2 px-1 rounded-xl text-[11px] font-semibold transition-all duration-200 truncate bg-gradient-to-br ${role.color} text-white hover:opacity-80 disabled:opacity-50 shadow-sm`}
                >
